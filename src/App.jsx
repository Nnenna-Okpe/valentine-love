...
import Vals13 from "./component/vals13.jsx";
import Vals14 from "./component/vals14.jsx";
import Vals15 from "./component/vals15.jsx";
    ...
    <div className="App">
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/vals13" element={<Vals13 />} />
          <Route path="/vals14" element={<Vals14 />} />
          <Route path="/vals15" element={<Vals15 />} />
        </Routes>
        <Footer />
      </Router>
    </div>
